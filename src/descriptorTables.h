...
extern void int0xUnknown_handler(IntRegisters regs);
extern void int0x80_handler(IntRegisters regs);
extern void int0x20_handler(IntRegisters regs);
extern void int0x21_handler(IntRegisters regs);
extern void int0x8_handler();
